	...
	<div class="container-fluid">
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="expdate">Data de expiração</label>
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Continuar Pagamento" class="checkout-btn">
				</form>
				</div>
			</div>
			';
		...
		?>
			...
			<div class="col-25">
				...
				<h3>Total<span class='price' style='color:black'><b>$total Kz</b></span></h3>";
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Inscreva-se para o <strong>NEWSLETTER</strong></p>
							<form >
								<input class="input" type="email" placeholder="Introduza o seu Email">
								<button class="newsletter-btn"><i class="fa fa-envelope"></i> Subscriver</button>
							</form>
