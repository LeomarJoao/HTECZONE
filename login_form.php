						...
						<!-- /Billing Details -->
								...
								<form onsubmit="return false" id="login" class="login100-form ">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Iniciar Sessão</h2>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       <label for="email">Password</label>
                                        <input class="input input-borders" type="password" name="password" placeholder="Senha" id="password" required>
                                    </div>
