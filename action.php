                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist' tabindex='0'><i class='fa fa-heart-o'></i><span class='tooltipp'>Adicionar a Lista de Desejos</span></button>
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>Adicionar para Comparação</span></button>
											<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>Visualização Rápida</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> Adicionar no Carrinho</button>
									</div>
								</div>
							</div>
			";
			...
			<form method="post" action="login_form.php">
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						...
						<tr>
							...
							<td data-th="Preço"><input type="text" class="form-control price" value="'.$product_price.'" readonly="readonly"></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Finalizar Compra</a></td>
								</tr>
							</tfoot>
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="griberomao@gmail.com">
