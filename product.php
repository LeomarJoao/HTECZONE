                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 Avalição(s) | Adicione sua avaliação</a>
							</div>
							<div>
								<h3 class="product-price">$'.$row['product_price'].'<del class="product-old-price">$990.00</del></h3>
								<span class="product-available">No Stock</span>
							</div>
							...
							<ul class="product-btns">
								...
								<li><a href="#"><i class="fa fa-exchange"></i> Adicionar para comparar</a></li>
							</ul>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Grine</h5>
															<p class="date">27 DEC 2022, 8h:30 minutos</p>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>990 Kz</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
