         ...
         <div class="col-md-7">
            <div class="card">
              <div class="card-header card-header-primary">
                <h5 class="title">Adicionar Produtos</h5>
              </div>
              <div class="card-body">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Palavras-chave do produto</label>
              ...
              <div class="card-footer">
                  <button type="submit" id="btn_save" name="btn_save" required class="btn btn-fill btn-primary">Actualizar Produto</button>
              </div>
            </div>
          </div>
