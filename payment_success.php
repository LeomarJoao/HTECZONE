						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								<div class="navbar-header">
									<a href="#" class="navbar-brand">HTECZONE</a>
								</div>
...
concluído com sucesso e seu id de transação é <b><?php echo $trx_id; ?></b><br/>
											você pode continuar suas compras<br/></p>
											<a href="index.php" class="btn btn-success btn-lg">Continuar a comprar</a>
										</div>
