				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							...
							<div class="shop-body">
								<h3>Laptops<br>Coleção</h3>
								<a href="product.php?p=78" class="cta-btn">Comprar Agora <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Accessórios<br>Coleção</h3>
								<a href="product.php?p=72" class="cta-btn">Comprar Agora <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>Câmeras<br>Coleção</h3>
								<a href="product.php?p=79" class="cta-btn">Comprar Agora <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Câmeras</a></li>
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>990KZ</del></h4>
										...
										<div class='product-btns'>
											...
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>Adicionar para Comparação</span></button>
											<button class='quick-view'><i class='fa fa-eye'></i><span class='tooltipp'>Visualização Rápida</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> Adicionar no Carrinho</button>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<h2 class="text-uppercase">Negócio quente esta semana</h2>
							<p>Nova coleção com até 50% de desconto</p>
							<a class="primary-btn cta-btn" href="store.php">Comprar Agora</a>
						</div>
					</div>
				</div>
				<!-- /row -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab2">Camisolas</a></li>
									<li><a data-toggle="tab" href="#tab2">T-Shirts</a></li>
									<li><a data-toggle="tab" href="#tab2">Calças</a></li>
								</ul>
							</div>
						</div>
					</div>
                        ...
                        echo "
								...
								<div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist'><i class='fa fa-heart-o'></i><span class='tooltipp'>Adicionar a Lista de Desejos</span></button>
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>Adicionar a Lista de Comparação</span></button>
											<button class='quick-view'><i class='fa fa-eye'></i><span class='tooltipp'>Visualização Rápida</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">Top de Vendas</h4>
							<div class="section-nav">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-3">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Categoria</p>
										<h3 class="product-name"><a href="#">Nome do produto vem aqui</a></h3>
										<h4 class="product-price">980Kz <del class="product-old-price">990Kz</del></h4>
									</div>
								</div>
								<!-- /product widget -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="section-title">
							<h4 class="title">Top das Vendas</h4>
							<div class="section-nav">
