...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='store.php'>Electronicos</a></li>
	";
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<del class='product-old-price'>990Kz</del></h4>
									</div></a>
								</div>
			...
			echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> Adcionar no Carrinho</button>
									</div>
								</div>
                                </div>
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											...
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>Adcionar para Comparação</span></button>
											<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>Visualização Rápida</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
